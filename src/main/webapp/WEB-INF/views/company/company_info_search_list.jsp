		...
		<div align="center">
			<ul class="pagination">
				<c:if test="${pb.previousPageGroup }">
					<li><a onclick="paging(${pb.startPageOfPageGroup-1})">&laquo;</a></li>
				</c:if>
...
<form action="${pageContext.request.contextPath}/user-companySearchList.do" id="pagingForm">	
	<input type="hidden" name="pageNum" value="" id="pageNumInput">
	<input type="hidden" name="address" value="${param.address}">
	<input type="hidden" name="companyName" value="${param.companyName}">
	<c:forEach  items="${paramValues.companyTypeList}" var="companyType">
	<input type="hidden" name="companyTypeList" value="${companyType}">
	</c:forEach>
</form>
